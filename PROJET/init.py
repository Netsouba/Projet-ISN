...
menu_over=pygame.image.load("Images/Menu_over.png").convert()
retry_over=pygame.image.load("Images/Retry_over.png").convert()
skip_over=pygame.image.load("Images/Skip.png").convert()
